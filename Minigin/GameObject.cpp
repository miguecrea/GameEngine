...
dae::GameObject::~GameObject() = default;
	...
	void dae::GameObject::FixedUpdate()
	{
		for (auto& pComponent : m_pComponents)
		{
			pComponent->FixedUpdate();      // //calls Update function on all the compoennts 
	...
	void dae::GameObject::Render() const
	{
		for (auto& pComponent : m_pComponents)
		{
			pComponent->Render();                    //calls render function on all the compoennts 
		}
	...
	void dae::GameObject::AddComponent(std::shared_ptr<Component> pComponent)
	{
		...
		pComponent->SetOwner(this);   //set ownership                    

		m_pComponents.push_back(pComponent);   //add it to the vector of comoonents
